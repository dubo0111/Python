...
#                branch_step = round(p/2) #
                ...
                y13,t13, cut13, opt13, val13, gap13, conv13, pool13,Heu_sol13 = bc_PR.bra_cut(
...
#                    print('!!!!!!!!!!!!!!')
#                    time.sleep(100000)
#                plt.plot(conv12[2],conv12[0],conv12[2],#                plt.show()
...
#                y13,t13, cut13, opt13, val13, gap13 = [0,0,0,0,0,0]
                ...
                result_i = [n_N, n_k, t3, gap3, t2, cut2, gap2, t1, cut1, gap1, t12, cut12, gap12,Heu_sol12[0],Heu_sol12[1],Heu_sol12[2],t13, cut13, gap13,Heu_sol13[0],Heu_sol13[1],Heu_sol13[2]]
