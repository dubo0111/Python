    ...
    for n_N in ex_N:
        for n_k in ex_k:
            for n_e in range(ex_all):
                ...
                # print(rnd_seed)
                ###
                y1,t1, cut1, opt1, val1, gap1 = bc.bra_cut(p, cd, cdk, sk, a1) # branch and cut
                y10,t10, cut10, opt10, val10, gap10 = bc_LB.bra_cut(p, cd, cdk, sk, a1) # LB
                y11,t11, cut11, opt11, val11, gap11 = bc_LBRoot.bra_cut(p, cd, cdk, sk, a1) # local branching
                y12,t12, cut12, opt12, val12, gap12 = bc_VN.bra_cut(p, cd, cdk, sk, a1) # variable neighbourhood branching
