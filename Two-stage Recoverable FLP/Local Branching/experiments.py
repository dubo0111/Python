...
ex_k = [20,70,80,90,100] # number of scenarios
ex_all = 5 # number of experiments for each combination
# problem parameters
a1 = 0.5
rnd_seed = 101 # starting random seed
...
#                y10,t10, cut10, opt10, val10, gap10, conv10 = bc_LB.bra_cut(p, cd, cdk, sk, a1, tl_total,branch_step) # LB
